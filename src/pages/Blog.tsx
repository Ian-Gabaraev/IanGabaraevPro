      ...
      <Helmet>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            description:
              "Articles on software engineering, full stack development, bioacoustics, DSP, and machine learning.",
      ...
      <div className="container">
        ...
        >
          ...
          <p className="blog-subtitle">
            Thoughts on software engineering, side projects, and the occasional
            deep dive.
          </p>
